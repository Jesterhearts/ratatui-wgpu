...
fn from_gray_unpacked<const BITS: usize, const ENTRIES: usize>(
        ...
        .zip(image.chunks_mut(raster.width as usize))
    {
        ...
        for (bits, dst) in bits.chunks(BITS).zip(dst.iter_mut()) {
            ...
            *dst = u32::from_be_bytes([255, value, value, value]);
        }
    }
}
...
mod tests {
    ...
    fn bmp2() {
        ...
        assert_eq!(
            ...
            bytemuck::cast_slice(&[
                [
                    [LUT_2[0b10], LUT_2[0b10], LUT_2[0b10], 255,],
                    [LUT_2[0b10], LUT_2[0b10], LUT_2[0b10], 255,],
                    [LUT_2[0b11], LUT_2[0b11], LUT_2[0b11], 255,],
                    [LUT_2[0b01], LUT_2[0b01], LUT_2[0b01], 255,],
                    [LUT_2[0b00], LUT_2[0b00], LUT_2[0b00], 255,],
                    [LUT_2[0b00], LUT_2[0b00], LUT_2[0b00], 255,],
                ],
                [
                    [LUT_2[0b01], LUT_2[0b01], LUT_2[0b01], 255,],
